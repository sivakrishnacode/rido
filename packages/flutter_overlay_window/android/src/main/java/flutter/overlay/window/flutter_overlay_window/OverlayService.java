...
public class OverlayService extends Service implements View.OnTouchListener {
    ...
    private boolean openApp() {
        ...
        try {
            ...
            Log.w("OverlayService", "moveToFront failed: " + e.getMessage());
        }
        try {
            ...
            Log.w("OverlayService", "Could not open the app: " + e.getMessage());
            return false;
        }
    }
    ...
    private void handleBubbleTouch(MotionEvent event) {
        if (windowManager != null && WindowSetup.enableDrag) {
            WindowManager.LayoutParams params = (WindowManager.LayoutParams) flutterView.getLayoutParams();
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    // Touch slop (~8 dp) before a move counts as a drag.
                    float slop = 8 * mResources.getDisplayMetrics().density;
